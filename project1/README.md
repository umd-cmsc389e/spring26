...
7. Finally, click the `Play` button to open Minecraft, go to "Singleplayer", and you should see **Project 1** has been successfully imported into your singleplayer worlds!
